...
class Comment(TimestampRequiredMixin, ProjectMemberAuditMixin, Base):
    ...
    created_by_member = relationship(
        "ProjectMember", foreign_keys="Comment.created_by", back_populates="created_comments"
    )
    updated_by_member = relationship(
        "ProjectMember", foreign_keys="Comment.updated_by", back_populates="updated_comments"
    )
    deleted_by_member = relationship(
        "ProjectMember", foreign_keys="Comment.deleted_by", back_populates="deleted_comments"
    )
